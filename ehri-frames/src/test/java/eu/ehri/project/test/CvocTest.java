...
public class CvocTest extends ModelTestBase {
	...
	public void testConceptHierarchy() throws Exception {
		...
		helpers.createIndex("concept", Vertex.class);
		
	    Map<String, Object> data = new HashMap<String, Object>() {{put("identifier", "fruit");}};
		Vertex v_fruit = helpers.createIndexedVertex(data, "concept");

	    data = new HashMap<String, Object>() {{put("identifier", "apples");}};
	    Vertex v_apples = helpers.createIndexedVertex(data, "concept");

	    data = new HashMap<String, Object>() {{put("identifier", "bananas");}};
	    Vertex v_bananas = helpers.createIndexedVertex(data, "concept");

	    data = new HashMap<String, Object>() {{put("identifier", "trees");}};
	    Vertex v_trees = helpers.createIndexedVertex(data, "concept");
