...
/**
 * The unit testing is done in the ehri-frames project because  
 * the EhriNeo4jPlugin is just a thin wrapper around the EhriNeo4j class in the ehri-frames project. 
 * 
